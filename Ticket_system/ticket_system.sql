...
--
-- Host: 127.0.0.1
-- Generation Time: Cze 29, 2024 at 12:03 AM
...
CREATE TABLE `users` (
  ...
  `department` enum('IT','HR','Finance','Marketing') DEFAULT NULL,
  `role` enum('admin','department_owner','user') NOT NULL DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
