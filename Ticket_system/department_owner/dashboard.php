...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] != 'department_owner') {
...
// Fetch tickets assigned to the department owner
$sql = "SELECT * FROM tickets WHERE assigned_to = $user_id OR department IN (SELECT department FROM users WHERE id = $user_id)";
...
<head>
    <meta charset="UTF-8">
    <title>Department Owner Dashboard</title>
...
<body>
    ...
    <div class="main-content">
        <h1>Department Owner Dashboard</h1>
        <table>
            <tr>
                <th>Title</th>
                <th>Priority</th>
